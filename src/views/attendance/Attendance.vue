            ...
            <article class="tbl-row no-hover" v-for="student in pagedAttendList" :key="student.code">
                ...
                <div class="radio-group">
                    <label><input type="radio" :name="'status-' + student.code"
                            value="attend" v-model="student.status" @change="saveDraft"/> 출석</label>
                    <label><input type="radio" :name="'status-' + student.code"
                            value="late" v-model="student.status" @change="saveDraft"/> 지각</label>
                    <label><input type="radio" :name="'status-' + student.code"
                            value="absent" v-model="student.status" @change="saveDraft"/> 결석</label>
                </div>
                <div>
